...
class RTask extends Task
{
    ...
    public function onRun() : void
    {
        ...
        $this->plugin->getServer()->broadcastMessage($api->getSetting("prefix") . "§7Entschlüssle das Wort unten und schreibe es in den Chat!\n\n§6-> §e" . str_shuffle($word) . "\n\n" . $api->getSetting("prefix") . "§7Der erste Spieler erhält §a" . $price . "€§7!");
