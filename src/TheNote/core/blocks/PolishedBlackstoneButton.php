...
class PolishedBlackstoneButton extends Opaque
{

	public function __construct(BlockIdentifier $idInfo, ?BlockBreakInfo $breakInfo = null)
	{
		parent::__construct($idInfo, "Polished Blackstone Button",$breakInfo ?? new BlockBreakInfo(0.9, BlockToolType::PICKAXE));
	}
