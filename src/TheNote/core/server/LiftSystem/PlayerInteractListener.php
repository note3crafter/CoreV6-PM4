...
class PlayerInteractListener extends LiftListener implements Listener
{
    public function onPlayerInteract(PlayerInteractEvent $event) {
        ...
        if($event->getBlock()->getId() === ItemIds::DAYLIGHT_SENSOR) {
            $event->getBlock()->getPosition()->getWorld()->setBlock($event->getBlock()->getPosition()->asVector3(), Block::get(ItemIds::DAYLIGHT_SENSOR_INVERTED));
            ...
            $event->getBlock()->getPosition()->getWorld()->setBlock($event->getBlock()->getPosition()->asVector3(), Block::get(ItemIds::DAYLIGHT_SENSOR));
